    ...
    <div className="flex" style={{ height: "calc(100vh - 60px)" }}> 
      ...
      <Card className="hidden lg:block w-1/4 border-0 rounded-none transition-colors duration-500 ease-in-out">
       <h5 className="mb-2 text-3xl font-bold text-gray-900 dark:text-white">DEXXOS MARKET</h5>
        {allDataAvailable && (
          ...
          >
            ...
            <div className="flex justify-between ">
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white ">Distancia</h4>
              <div className="text-xl font-medium text-gray-900 dark:text-white">
                <span id="distance ">{distance}</span>
              </div>
            </div>
            <div className="flex justify-between mt-4">
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white ">ETA</h4>
              <div className="text-xl font-medium text-gray-900 dark:text-white">
                <span id="eta ">{duration}</span>
              </div>
            </div>
            ...
            <div className="flex justify-between mt-4">
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white ">Destino</h4>
              <div className="text-xl font-medium text-gray-900 dark:text-white">
                <span id="arrival">{endLocation.title}</span>
              </div>
            </div>
        ...
        <h4 className="text-2xl font-semibold mt-8 text-gray-900 dark:text-white ">Locales</h4>
